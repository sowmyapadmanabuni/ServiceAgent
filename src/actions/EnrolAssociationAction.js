...
export const EnrolAssociaiton =(AssociationName,AssociationAddress,PropertyName,Country,State,City,Pincode,EmailID,NoofBlocks,NoofUnits,PanNumber,navigation)=>{
    return dispatch => {
 ...
 Amenities :[{
   ...
   //   navigation.navigate("EnrolDevice");
