...
import {onAdminFieldChange,AdminAccountCreate,AdminAccountUpdate,resetAdminFom} from "../../actions";
...
class AdministratorDetails extends Component{
    ...
    AdminDetailsValidation=()=>{
        ...
        if(Validation.Mobileregex.test(MobileNumber) === false)
        {
            ...
            //this.props.AdminAccountCreate(Name,MobileNumber)
...
export default connect(mapStateToProps,{AdminAccountCreate,onAdminFieldChange,AdminAccountUpdate,resetAdminFom})(AdministratorDetails);