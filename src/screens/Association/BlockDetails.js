...
import {onEnrollFieldChange,EnrolAssociaiton} from "../../actions";
...
class BlockDetails extends Component{
    ...
    componentWillUnmount(){}
     ...
     BlockValidation=()=>{
         const{AssociationName,AssociationAddress,PropertyName,Country,State,City,Pincode,EmailID,NoofBlocks,NoofUnits,PanNumber}=this.props;
         ...
         else if(Number(NoofUnits) < Number(NoofBlocks))
         {
             alert('Noof Units cant be more than Noof Blocks');
               ...
               this.props.EnrolAssociaiton(AssociationName,AssociationAddress,PropertyName,Country,State,City,Pincode,EmailID,NoofBlocks,NoofUnits,PanNumber,this.props.navigation);
...
export default connect(mapStateToProps,{onEnrollFieldChange,EnrolAssociaiton})(BlockDetails);
