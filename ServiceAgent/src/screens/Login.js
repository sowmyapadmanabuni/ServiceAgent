...
class Login extends Component {
  ...
  render() {
    ...
    return (
      <View>
        ...
        <View style={GlobalStyle.buttonTextSyle}>{this.renderButton()}</View>
      </View>
    );
  }
  ...
  MobileNumberCheck = () => {
    ...
    axios
      .get(
        api.oyeServiceAgentUrl +
          "ServiceAgent/GetServiceAgentDetailsByMobileNo",
        {
          headers: {
      ...
      .then(res => {
        ...
        if (foundData) {
          ...
          alert(
            "MobileNumber is not registered. Please Contact Your Administrator"
          );
        }
      })
      .catch(error => {
