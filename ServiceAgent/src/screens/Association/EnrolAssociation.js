...
class EnrolAssociation extends Component {
        ...
        <View>
          ...
          <Card>
            <View style={GlobalStyle.cardContainerStyle}>
              <Text style={GlobalStyle.noMargins}>
                {" "}
                Association Name{" "}
                <Text style={{ color: base.theme.colors.red }}>*</Text>
              </Text>
              <TextInput
                style={GlobalStyle.noMargins}
            ...
            <View style={GlobalStyle.cardContainerStyle}>
              <Text style={GlobalStyle.noMargins}>
                {" "}
                Country <Text style={{ color: base.theme.colors.red }}>*</Text>
              </Text>
              <TextInput
                style={GlobalStyle.noMargins}
            ...
            <View style={GlobalStyle.cardContainerStyle}>
              <Text style={GlobalStyle.noMargins}>
                {" "}
                State <Text style={{ color: base.theme.colors.red }}>*</Text>
              </Text>
              <TextInput
                style={GlobalStyle.noMargins}
            ...
            <View style={GlobalStyle.cardContainerStyle}>
              <Text style={GlobalStyle.noMargins}>
                {" "}
                City <Text style={{ color: base.theme.colors.red }}>*</Text>
              </Text>
              <TextInput
                style={GlobalStyle.noMargins}
            ...
            <View style={GlobalStyle.cardContainerStyle}>
              <Text style={GlobalStyle.noMargins}>
                {" "}
                Pincode <Text style={{ color: base.theme.colors.red }}>*</Text>
              </Text>
              <TextInput
                style={GlobalStyle.noMargins}
  ...
  AssociationDetailsValidation = () => {
    ...
    if (
      Validation.AlphaNumeric.test(AssociationName) === false ||
      AssociationName.length < 3
    ) {
      alert("Enter Valid Association Name");
    } else if (
      Validation.Alphabets.test(AssociationAddress) === false ||
      AssociationAddress.length < 3
    ) {
      alert("Enter Valid Association Address");
    } else if (
      Validation.Alphabets.test(PropertyName) === false ||
      PropertyName.length < 3
    ) {
      alert("Enter Valid Property Name");
    } else if (
      Validation.Alphabets.test(Country) === false ||
      Country.length < 3
    ) {
      ...
      Validation.Numeric.test(Pincode) === false ||
      Pincode.length < 3
    ) {
...
export default connect(
  mapStateToProps,
  { onEnrollFieldChange, resetEnrolFom }
)(EnrolAssociation);
