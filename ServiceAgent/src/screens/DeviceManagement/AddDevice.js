...
class AddDevice extends Component {
    ...
    return (
      <ScrollView>
        ...
        <View style={GlobalStyle.Title}>
          <Text style={{ color: base.theme.colors.primary, marginBottom: 20 }}>
            {" "}
            Device Management{" "}
          </Text>
        </View>
        ...
        <Card>
          ...
          <View style={GlobalStyle.cardContainerStyle}>
            ...
            <TextInput
              ...
              value={IMEINumber}
              onChangeText={IMEINumber =>
                onDeviceFieldChange({ prop: "IMEINumber", value: IMEINumber })
              }
            />
          </View>
          <View style={GlobalStyle.cardContainerStyle}>
            ...
            <TextInput
              ...
              value={GateName}
              onChangeText={GateName =>
                onDeviceFieldChange({ prop: "GateName", value: GateName })
              }
            />
          </View>
  ...
  getAssociationID = () => {
    ...
    axios
      .get(api.oyeLivingUrl + "association/getassociationlist", {
        headers: {
...
export default connect(
  mapStateToProps,
  { onDeviceFieldChange, DeviceCreate }
)(AddDevice);
